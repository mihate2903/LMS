...
const ProfilePage = () => {
  ...
  // Form states
  const [infoForm, setInfoForm] = useState({ name: '', phone: '', email: '', avatarUrl: '' });
    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-1">Quản lý các thông tin cá nhân và cài đặt bảo mật của bạn.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm text-center">
              ...
              <div className="inline-flex items-center px-3 py-1 bg-primary-50 text-primary-700 text-xs font-bold rounded-full uppercase tracking-wider">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm relative overflow-hidden">
               ...
               <form onSubmit={handleInfoUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="md:col-span-2">
                   ...
                   />
                   <p className="mt-1 text-[11px] text-slate-400 italic font-medium">Lưu ý: Thay đổi Email có thể ảnh hưởng đến thông tin đăng nhập của bạn.</p>
                 </div>
